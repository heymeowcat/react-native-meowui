...
export const gradients = {
  primary: ['#D946EF', '#D946EF'] as const,   
  secondary: ['#FACC15', '#FACC15'] as const, 
  accent: ['#06B6D4', '#06B6D4'] as const,    
  success: ['#22C55E', '#22C55E'] as const,
  warning: ['#F97316', '#F97316'] as const,
  error: ['#EF4444', '#EF4444'] as const,
  neutral: ['#1F2937', '#1F2937'] as const,
  
  sunset: ['#FACC15', '#F97316', '#EF4444'] as const,
  ocean: ['#06B6D4', '#3B82F6', '#6366F1'] as const,
  aurora: ['#A3E635', '#22C55E', '#10B981'] as const,
  fire: ['#FCA5A5', '#EF4444', '#B91C1C'] as const,
} as const;
...
export const getGradient = (name: GradientName): readonly string[] => gradients[name];
