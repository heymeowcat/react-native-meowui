...
export const useAnimatedPress = (options = {}) => {
    const { theme } = useTheme();
    const { scaleDown = theme.animations.pressAnimation.scale, opacityDown = theme.animations.pressAnimation.opacity, } = options;
