...
export const FAB = ({ icon, label, onPress, variant = 'gradient', size = 'medium', gradientColors, disabled = false, style, }) => {
    ...
    return (<AnimatedPressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} disabled={disabled} style={[
            animatedStyle,
            getContainerStyle(),
