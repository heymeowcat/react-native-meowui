...
export const Card = ({ children, variant = 'elevated', elevation = 2, gradient = false, // Ignored in new style
gradientColors, // Ignored
gradientBorder = false, // Ignored
onPress, disabled = false, style, contentStyle, }) => {
    ...
    return (<AnimatedPressable onPress={onPress} onPressIn={handlePressIn} onPressOut={handlePressOut} disabled={disabled || !onPress} style={[
            animatedStyle,
            getVariantStyles(),
            style
        ]}>
